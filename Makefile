...
ifndef HAS_ADDLICENSE
	go install -mod=readonly gitlab.com/google/addlicense
endif
...
ifneq ($(HAS_GOLANGCI_VERSION), $(GOLANGCI_VERSION))
	curl -sSfL https://raw.gitlabusercontent.com/golangci/golangci-lint/master/install.sh | sh -s -- -b $(GOPATH)/bin v$(GOLANGCI_VERSION)
endif
